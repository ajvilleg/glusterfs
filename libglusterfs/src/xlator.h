...
typedef int32_t (*fop_writev_vers_cbk_t) (call_frame_t *frame,
                                     void *cookie,
                                     xlator_t *this,
                                     int32_t op_ret,
                                     int32_t op_errno,
...
typedef int32_t (*fop_writev_vers_t) (call_frame_t *frame,
                                 xlator_t *this,
                                 fd_t *fd,
                                 struct iovec *vector,
                                 int32_t count,
...
struct xlator_fops {
        ...
        fop_writev_vers_cbk_t    writev_vers_cbk;
